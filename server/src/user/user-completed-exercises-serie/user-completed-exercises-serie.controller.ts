...
export class UserCompletedExercisesSerieController {
  constructor(
    private readonly genericService: GenericService<UserCompletedExercisesSerie>,
  ) {}
  ...
  @UseGuards(AuthGuard)
  @ApiOperation({
    summary: 'Create a new user completed exercise series record',
  })
  @ApiResponse({
    status: 201,
    description: 'Record successfully created',
    type: UserCompletedExercisesSerie,
  })
  async create(
    @Body()
    createUserCompletedExercisesSerieDto: CreateUserCompletedExercisesSerieDto,
  ) {
    const completedSerie = await this.genericService.findOne(
      'userCompletedExercisesSerie',
      {
        where: {
          idUserCompletedExercisesSerie: {
            serieId: createUserCompletedExercisesSerieDto.serieId,
            userId: createUserCompletedExercisesSerieDto.userId,
          },
        },
      },
    );
    if (completedSerie) {
      return { message: 'Serie already completed' };
    }
    return this.genericService.create(
      'userCompletedExercisesSerie',
      createUserCompletedExercisesSerieDto,
    );
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Return the user completed series.',
    type: UserCompletedExercisesSerie,
  })
  ...
  @UseGuards(AuthGuard)
  @ApiOperation({
    summary: 'Get a specific user completed exercise series record',
  })
  @ApiResponse({
    status: 200,
  ...
  @UseGuards(AuthGuard)
  @ApiOperation({
    summary: 'Update a specific user completed exercise series record',
  })
  @ApiResponse({
    status: 200,
  ...
  update(
    ...
    @Body()
    updateUserCompletedExercisesSerieDto: UpdateUserCompletedExercisesSerieDto,
  ) {
  ...
  @UseGuards(AuthGuard)
  @ApiOperation({
    summary: 'Delete a specific user completed exercise series record',
  })
