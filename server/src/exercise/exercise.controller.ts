...
export class ExerciseController {
  ...
  @ApiResponse({
    status: 200,
    description: 'The exercice has been successfully created.',
    type: Exercise,
  })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  create(@Body() createExerciseDto: CreateExerciseDto) {
    createExerciseDto.answer = createExerciseDto.answer
      .toLowerCase()
      .replace(/[.,!?;:'"]/g, '')
      .trim();
  ...
  @ApiResponse({
    status: 200,
    description: 'The exercices has been successfully created.',
    type: Exercise,
  })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Return all exercices.',
    type: [Exercise],
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Return the exercice.',
    type: Exercise,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The exercice has been successfully updated.',
    type: Exercise,
  })
  @ApiResponse({ status: 403, description: 'Forbidden.' })
  update(
  ...
  @ApiResponse({
    status: 200,
    description: 'The exercice has been successfully deleted.',
    type: Exercise,
  })
  @ApiResponse({ status: 403, description: 'Forbidden.' })
