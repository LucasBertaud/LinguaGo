<template>
    <router-link 
        :to="link" 
        class="text-white flex items-center gap-3 w-40 rounded-lg px-4 py-2.5 font-semibold hover:bg-white hover:text-slate-600 group hover:shadow-xs hover:shadow-slate-300/50 active:bg-white/75 active:text-slate-800 active:shadow-slate-300/10"
