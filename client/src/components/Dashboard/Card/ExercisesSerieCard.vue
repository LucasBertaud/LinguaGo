<template>
  <div 
    ...
    <FavoriteButton :serie-id="id" :user-favorite-serie="userFavoriteSerie" />
    <div 
...
const userFavoriteSerie: UserFavoriteSerie | undefined = props.favoriteUsers.find((favorite) => favorite.userId === store.getters.getUser.id && favorite.serieId === props.id);
